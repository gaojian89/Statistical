...
public class UserData {
    ...
    static void setData(Map<String, String> data){
        ...
        if(picturePath != null){
            ...
            if (!sourceFile.isFile()) {
                if (Statistical.sharedInstance().isLoggingEnabled()) {
                    Log.w(Statistical.TAG, "Provided file " + picturePath + " can not be opened");
                }
                picturePath = null;
            }
        }
        ...
        if(data.containsKey(BYEAR_KEY)){
            try {
                ...
                if (Statistical.sharedInstance().isLoggingEnabled()) {
                    Log.w(Statistical.TAG, "Incorrect byear number format");
                }
                byear = 0;
            }
        }
    ...
    static JSONObject toJSON() {
        ...
        try {
            ...
            if (Statistical.sharedInstance().isLoggingEnabled()) {
                Log.w(Statistical.TAG, "Got exception converting an UserData to JSON", e);
            }
        }
        ...
        if(json != null){
            ...
            if (!json.isNull(CUSTOM_KEY)) {
                ...
                try {
                    ...
                    if (Statistical.sharedInstance().isLoggingEnabled()) {
                        Log.w(Statistical.TAG, "Got exception converting an Custom Json to Custom User data", e);
                    }
                }
            }
        }
